...
class BTextTheme {
  ...
  static TextTheme lightTextTheme = GoogleFonts.poppinsTextTheme().copyWith(
    ...
    labelSmall: const TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.75)), 
  );
  ...
  static TextTheme darkTextTheme = GoogleFonts.poppinsTextTheme().copyWith(
    ...
    labelSmall: const TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.75)),
  );
}
